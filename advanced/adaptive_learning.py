...
class PromptOptimizer:
    ...
    def track_hypothesis_result(
        self, prompt_stage: str, temperature: float, was_successful: bool
    ):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {stage: asdict(perf) for stage, perf in self.prompt_performance.items()}

    def from_dict(self, data: Dict[str, Any]):
        """Load from dictionary"""
        self.prompt_performance = {
            stage: PromptPerformance(**perf_data) for stage, perf_data in data.items()
        }
...
class PatternLearner:
    ...
    def extract_patterns(
        self, verified_vulnerabilities: List[Dict[str, Any]]
    ) -> List[Dict[str, Any]]:
    ...
    def _extract_pattern(self, vulnerability: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "detection_strategy": vulnerability.get(
